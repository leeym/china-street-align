...
The other two pairings already match without the extension: **太和殿 · Map** (GCJ place on GCJ map) and **`39°54′57.0″N 116°23′26.0″E` · Satellite** (WGS query on WGS photo).
